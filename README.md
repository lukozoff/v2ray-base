...
Проект находиться в активной разработке и поэтому тут могут появляться новые функции и тд
...
Источники: Конфигурации собираются из открытых источников и проходят автоматическую фильтрацию моим скриптом.

Обновление: Репозиторий обновляется вручную, а не по расписанию.

Работоспособность: Я не гарантирую 100% стабильность каждого конфига. Бесплатные сервера могут «умереть» в любую секунду сразу после проверки.
